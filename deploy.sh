...
kubectl set image deployments/worker-deployment worker=ulrichjohannes/multi-worker:$SHA
kubectl set image deployments/client-deployment client=ulrichjohannes/multi-client:$SHA
